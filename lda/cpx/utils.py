...
# Wrapper Class
class CplexClassifierFitter(object):
    ...
    def __init__(self, data, print_flag = False, **kwargs):
        """
        :param data:
        :param kwargs:
        """
        ...
        # check inputs
        settings = CplexClassifierFitter.SETTINGS

        # build MIP
        self.mip_data = self.to_mip_data(data)
        cpx, info = self.build_mip(**settings)
